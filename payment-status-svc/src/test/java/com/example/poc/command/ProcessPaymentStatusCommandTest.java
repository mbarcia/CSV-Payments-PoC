...
class ProcessPaymentStatusCommandTest {
  ...
  @InjectMocks ProcessPaymentStatusCommand processPaymentStatusCommand;
  ...
  void execute() {
    ...
    AckPaymentSent ackPaymentSent =
        new AckPaymentSent().setPaymentRecord(paymentRecord).setStatus(1L).setMessage("SUCCESS");
    PaymentStatus paymentStatus =
        new PaymentStatus()
            .setAckPaymentSent(ackPaymentSent)
            .setMessage("Payment processed successfully")
            .setFee(new BigDecimal("1.50"));
