...
class PaymentRecordMapperTest {
  ...
  void testDtoToGrpc() {
    ...
    assertEquals(dto.getCsvPaymentsInputFilePath().toString(), grpc.getCsvPaymentsInputFilePath());
  }
  ...
  void testDomainToGrpc() {
    ...
    assertEquals(
        domain.getCsvPaymentsInputFilePath().toString(), grpc.getCsvPaymentsInputFilePath());
  }
