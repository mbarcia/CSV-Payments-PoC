...
public class PollAckPaymentSentCommand implements ReactiveCommand<AckPaymentSent, PaymentStatus> {
    ...
    public PollAckPaymentSentCommand(Executor executor, PaymentProviderService paymentProviderServiceMock, PaymentProviderConfig config) {
        this.executor = executor;
    ...
    public Uni<PaymentStatus> execute(AckPaymentSent detachedAckPaymentSent) {
        ...
        return Uni.createFrom().item(detachedAckPaymentSent)
