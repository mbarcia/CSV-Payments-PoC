...
@ApplicationScoped
public class PollAckPaymentSentGrpcAdapterReactive
    extends GrpcReactiveServiceAdapter<
        PaymentsProcessingSvc.AckPaymentSent,
        PaymentsProcessingSvc.PaymentStatus,
        AckPaymentSent,
        PaymentStatus> {

  @Inject PollAckPaymentSentReactiveService domainService;
  ...
  @Override
  protected PollAckPaymentSentReactiveService getService() {
