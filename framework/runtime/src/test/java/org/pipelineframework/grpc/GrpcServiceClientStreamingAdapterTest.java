...
class GrpcServiceClientStreamingAdapterTest {
    ...
    @Mock private ReactiveStreamingClientService<DomainIn, DomainOut> mockReactiveService;
    ...
    void remoteProcess_FromGrpcTransformation() {
        ...
        ReactiveStreamingClientService<DomainIn, DomainOut> verificationService =
                new ReactiveStreamingClientService<>() {
                    @Override
        ...
        GrpcServiceClientStreamingAdapter<GrpcIn, GrpcOut, DomainIn, DomainOut>
                verificationAdapter =
                        new GrpcServiceClientStreamingAdapter<>() {
                            @Override
                            protected ReactiveStreamingClientService<DomainIn, DomainOut>
                                    getService() {
    ...
    void remoteProcess_ToGrpcTransformation() {
        ...
        GrpcServiceClientStreamingAdapter<GrpcIn, GrpcOut, DomainIn, DomainOut> trackingAdapter =
                new GrpcServiceClientStreamingAdapter<>() {
                    @Override
                    protected ReactiveStreamingClientService<DomainIn, DomainOut> getService() {
                        return mockReactiveService;
    ...
    void remoteProcess_ErrorInFromGrpcTransformation() {
        ...
        GrpcServiceClientStreamingAdapter<GrpcIn, GrpcOut, DomainIn, DomainOut> failingAdapter =
                new GrpcServiceClientStreamingAdapter<>() {
                    @Override
                    protected ReactiveStreamingClientService<DomainIn, DomainOut> getService() {
    ...
    void remoteProcess_ErrorInToGrpcTransformation() {
        ...
        Multi<GrpcIn> grpcRequestStream = Multi.createFrom().items(new GrpcIn());
        DomainOut domainOut = new DomainOut();
        RuntimeException transformationException =
                new RuntimeException("Output transformation failed");
