...
@PipelineStep(
    ...
    inputGrpcType = io.github.mbarcia.csv.grpc.PaymentsProcessingSvc.PaymentStatus.class,
    outputGrpcType = io.github.mbarcia.csv.grpc.PaymentStatusSvc.PaymentOutput.class,
