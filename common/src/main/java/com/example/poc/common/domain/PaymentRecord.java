...
public class PaymentRecord extends BaseEntity implements Serializable {
  ...
  @CsvIgnore @Transient private CsvPaymentsInputFile csvPaymentsInputFile;
  private String csvPaymentsInputFilePath;

  public PaymentRecord assignInputFile(CsvPaymentsInputFile csvPaymentsInputFile) {
    this.setCsvPaymentsInputFilePath(csvPaymentsInputFile.getFilepath());
    this.setCsvPaymentsInputFile(csvPaymentsInputFile);
