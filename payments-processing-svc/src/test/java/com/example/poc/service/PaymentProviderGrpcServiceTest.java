...
class PaymentProviderGrpcServiceTest {
  ...
  void sendPayment_happyPath() {
    // Given
    com.example.poc.grpc.PaymentStatusSvc.SendPaymentRequest grpcRequest =
        com.example.poc.grpc.PaymentStatusSvc.SendPaymentRequest.newBuilder()
            .setAmount("100.00")
            .setCurrency("USD")
    ...
    when(sendPaymentRequestMapper.fromGrpc(
            any(com.example.poc.grpc.PaymentStatusSvc.SendPaymentRequest.class)))
        .thenReturn(request);
