...
public class PollAckPaymentSentProducer {
	...
	@Inject
	PollAckPaymentSentOnVirtualThreadReactiveService vthreadImpl;
	...
	public PollAckPaymentSentService produce() {
		boolean runningOnVThread = Thread.currentThread().isVirtual();

		return runningOnVThread ? vthreadImpl : reactiveImpl;
	}
}