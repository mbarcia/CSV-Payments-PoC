...
/**
 * Inbound mapper for converting gRPC AckPaymentSent to domain AckPaymentSent.
 */
@ApplicationScoped
public class AckPaymentSentInboundMapper implements InboundMapper<PaymentsProcessingSvc.AckPaymentSent, AckPaymentSent> {

    @Inject
    AckPaymentSentMapper ackPaymentSentMapper;

    @Override
    public AckPaymentSent toDomain(PaymentsProcessingSvc.AckPaymentSent grpcIn) {
