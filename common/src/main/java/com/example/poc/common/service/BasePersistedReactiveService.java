...
public abstract class BasePersistedReactiveService<T extends BaseEntity, S>
    extends BaseReactiveService<T, S> {
  @Override
  public Uni<S> process(T processableObj) {
    return processableObj.save().replaceWith(super.process(processableObj));
  }
