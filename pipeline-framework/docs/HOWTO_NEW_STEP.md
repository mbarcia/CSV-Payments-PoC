...
Steps can be configured using the pipeline configuration system. See [Configuration Guide](CONFIGURATION.md) for detailed information on how to configure steps with profiles, defaults, and overrides.
