...
public @interface MapperForStep {
    ...
    /**
     * The gRPC input type for inbound mappers.
     * @return the gRPC input type class
     */
    Class<?> grpcInput() default Void.class;
    
    /**
     * The domain input type for inbound mappers.
     * @return the domain input type class
     */
    Class<?> domainInput() default Void.class;
    
    /**
     * The domain output type for outbound mappers.
     * @return the domain output type class
     */
    Class<?> domainOutput() default Void.class;
    
    /**
     * The gRPC output type for outbound mappers.
     * @return the gRPC output type class
     */
    Class<?> grpcOutput() default Void.class;
}