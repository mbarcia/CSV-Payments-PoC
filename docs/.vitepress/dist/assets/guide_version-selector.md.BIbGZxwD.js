...
import{_ as i,c as a,o as n,ag as t}from"./chunks/framework.DRADY2L-.js";const d=JSON.parse('{"title":"Version Selector","description":"","frontmatter":{},"headers":[],"relativePath":"guide/version-selector.md","filePath":"guide/version-selector.md"}'),e={name:"guide/version-selector.md"};function l(p,s,h,k,r,E){return n(),a("div",null,[...s[0]||(s[0]=[t(`<h1 id="version-selector" tabindex="-1">Version Selector <a class="header-anchor" href="#version-selector" aria-label="Permalink to &quot;Version Selector&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> default</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
