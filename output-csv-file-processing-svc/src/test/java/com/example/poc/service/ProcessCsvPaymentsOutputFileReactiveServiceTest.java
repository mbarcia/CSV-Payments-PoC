...
class ProcessCsvPaymentsOutputFileReactiveServiceTest {
  ...
  @InjectMocks ProcessCsvPaymentsOutputFileReactiveService service;

  @Mock ProcessPaymentOutputCommand command;
  ...
  void process() throws IOException {
    ...
    // When
    when(command.execute(any(Multi.class))).thenReturn(Uni.createFrom().item(expectedOutputFile));
